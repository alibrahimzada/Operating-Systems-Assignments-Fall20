...
#define LINES 64 /* total number of buffered command */ 
...
int main(void) {
    ...
    while (1) {
		...
		if (previousCommand) {
			...
			node->prevArg->line = malloc(sizeof(char*) * MAX_LINE / 2 + 1);
			copyArgs(node->prevArg->line, args);
